...
3. Follow the steps below to create a Cost and Usage report under the Legacy pages section, and not with data exports, following Datadog requirements

## Setup

### Prerequisite: generate a Cost and Usage Report

Follow AWS instructions for [Creating Cost and Usage Reports][1] under the **Legacy Pages** section, and not with data exports.
